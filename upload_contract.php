...
if (empty($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    header('Location: admin_login.php'); // أو غيرها حسب اسم صفحة دخول الأدمن عندك
    exit();
}
...
<head>
<meta charset="UTF-8">
<title>📁 إدارة ملفات الوحدة (خاص بالأدمن)</title>
<style>
...
<body>
    <h2>👨‍💼 رفع عقد وصورة وفيديو للوحدة (خاص بالأدمن)</h2>
    <form action="" method="POST" enctype="multipart/form-data">
        <label>🔢 رقم الوحدة (ID من جدول units):</label><br>
        ...
        <label>🎥 فيديو قصير للمشروع:</label><br>

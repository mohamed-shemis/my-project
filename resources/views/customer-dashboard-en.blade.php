...
<head>
  ...
  <style>
    ...
    body::before { content: ""; position: absolute; top: 0; left: 0; right: 0; bottom: 0;
      background: url('{{ asset('assets/img/687565a1f3f26B-03.jpg') }}') center center / cover no-repeat;
      z-index: -1; opacity: 1; }
...
<body>
  ...
  @if(!isset($user))
      <script>window.location.href = "{{ route('customer.login.en') }}";</script>
  @endif

  <div class="top-header">
    <div class="container">
      <div class="header-left">
        <span><a href="tel:19783"><img src="{{ asset('assets/img/phone.svg') }}" alt="Phone">19783</a></span>
        <span><a href="mailto:info@elamargroup.com"><img src="{{ asset('assets/img/mail.svg') }}" alt="Email">info@elamargroup.com</a></span>
        <span><a href="{{ route('customer.dashboard.ar') }}"><img src="{{ asset('assets/img/globe.svg') }}" alt="Language">AR</a></span>
        <span><a href="https://www.google.com/maps?q=120+El-Thawra+St+Heliopolis" target="_blank"><img src="{{ asset('assets/img/map.svg') }}" alt="Address">120 El-Thawra St, Heliopolis</a></span>
      </div>
    </div>
  </div>
  ...
  <header class="main-header">
    <div class="container">
      <div class="logo">
        <a href="/"><img src="{{ asset('assets/img/logo.png') }}" alt="El Amar Logo"></a>
      </div>
      <div class="group-right">
        <nav class="main-nav">
          <ul>
            ...
            <li><a class="active" href="{{ route('customer.dashboard.en') }}">Customer Login</a></li>
            <li><a href="/vendor">Vendors & Contractors</a></li>
          </ul>
        </nav>
      </div>
      <div class="social-links">
        <a href="https://facebook.com/Elamargroupeg" target="_blank"><img src="{{ asset('assets/img/facebook.svg') }}" alt="Facebook"></a>
        <a href="https://instagram.com/elamargroupeg" target="_blank"><img src="{{ asset('assets/img/instagram.svg') }}" alt="Instagram"></a>
        <a href="https://wa.me/201111111111" target="_blank"><img src="{{ asset('assets/img/whatsapp.svg') }}" alt="WhatsApp"></a>
      </div>
    </div>
  </header>
  ...
  <div class="header-video">
    <video autoplay muted loop playsinline>
      <source src="{{ asset('assets/video/customer-dashboard.mp4') }}" type="video/mp4">
  ...
  <div class="dashboard-container">
    <div class="dashboard-header">
      <div class="user-info">
        <img src="{{ asset('assets/img/section-title-icon.png') }}" alt="User">
    ...
    <div class="dashboard-grid">
      <div class="dash-card">
        ...
        <p><strong>Registered on:</strong> {{ $user->created_at ? $user->created_at->format('Y-m-d') : 'N/A' }}</p>
      </div>

...
<body>
      ...
      <div class="header-left">
        ...
        <span>
          <a href="mailto:info@elamargroup.com">
            <img src="<?php echo e(asset('assets/img/mail.svg')); ?>" alt="Email">
            <span class="hide-sm">info@elamargroup.com</span>
          </a>
        </span>
        <span>
          <a href="<?php echo e(route('customer.login.ar')); ?>">
            <img src="<?php echo e(asset('assets/img/globe.svg')); ?>" alt="Language">
            <span class="hide-sm">AR</span>
          </a>
        </span>
        <span>
          <a href="https://www.google.com/maps?q=120+El-Thawra+St+Heliopolis" target="_blank">
            <img src="<?php echo e(asset('assets/img/map.svg')); ?>" alt="Address">
  ...
  <header class="main-header">
    <div class="container">
      <div class="logo">
        <a href="/">
          <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="El Amar Logo">
        </a>
      </div>
      ...
      <div class="group-right">
        <nav class="main-nav">
          <ul>
            ...
            <li><a class="active" href="<?php echo e(route('customer.login.en')); ?>">Customer Login</a></li>
      ...
      <div class="social-links">
        <a href="https://facebook.com/Elamargroupeg" target="_blank">
          <img src="<?php echo e(asset('assets/img/facebook.svg')); ?>" alt="Facebook">
        </a>
...
<?php /**PATH C:\laragon\www\elamar-portal\resources\views/customer-en.blade.php ENDPATH**/ ?>
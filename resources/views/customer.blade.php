...
<body>
  ...
  <div class="top-header">
    <div class="container">
      <div class="header-left">
        ...
        <span>
          <a href="{{ route('customer.login.en') }}">
        ...
        <span>
          <a href="https://www.google.com/maps?q=120+El-Thawra+St+Heliopolis" target="_blank">
            <img src="{{ asset('assets/img/map.svg') }}" alt="العنوان">
  ...
  <header class="main-header">
    <div class="container">
      <div class="logo">
        <a href="/">
          <img src="{{ asset('assets/img/logo.png') }}" alt="شعار مجموعة العمار">
        </a>
      </div>
      ...
      <div class="group-right">
        <nav class="main-nav">
          <ul>
            ...
            <li><a class="active" href="{{ route('customer.login.ar') }}">تسجيل دخول</a></li>
      ...
      <div class="social-links">
        <a href="https://facebook.com/Elamargroupeg" target="_blank">
          <img src="{{ asset('assets/img/facebook.svg') }}" alt="فيسبوك">
        </a>
        <a href="https://instagram.com/elamargroupeg" target="_blank">
          <img src="{{ asset('assets/img/instagram.svg') }}" alt="إنستجرام">
        </a>
        <a href="https://wa.me/201111111111" target="_blank">
          <img src="{{ asset('assets/img/whatsapp.svg') }}" alt="واتساب">
        </a>
      </div>
    </div>
  </header>
